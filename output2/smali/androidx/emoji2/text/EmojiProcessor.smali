...
.method public process(Ljava/lang/CharSequence;IIIZ)Ljava/lang/CharSequence;
    ...
    .line 309
    .local v3, "nextSpanTransition":I
    if-gt v3, p3, :cond_3

    .line 310
    new-instance v4, Landroidx/emoji2/text/UnprecomputeTextOnModificationSpannable;

    invoke-direct {v4, p1}, Landroidx/emoji2/text/UnprecomputeTextOnModificationSpannable;-><init>(Ljava/lang/CharSequence;)V
    ...
    .line 302
    .end local v3    # "nextSpanTransition":I
    :cond_2
    :goto_0
    ...
    invoke-direct {v3, v4}, Landroidx/emoji2/text/UnprecomputeTextOnModificationSpannable;-><init>(Landroid/text/Spannable;)V
    ...
    .line 337
    .end local v3    # "spans":[Landroidx/emoji2/text/EmojiSpan;
    .end local v4    # "length":I
    .end local v5    # "index":I
    :cond_5
    if-eq p2, p3, :cond_b
    ...
    invoke-virtual {v1, v4, v3, v2}, Landroidx/emoji2/text/UnprecomputeTextOnModificationSpannable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
...
.method public final process(Ljava/lang/CharSequence;IIIZLandroidx/emoji2/text/EmojiProcessor$EmojiProcessCallback;)Ljava/lang/Object;
    ...
    .line 392
    invoke-virtual {p0, p1, p2, v2, v6}, Landroidx/emoji2/text/EmojiProcessor;->hasGlyph(Ljava/lang/CharSequence;IILandroidx/emoji2/text/TypefaceEmojiRasterizer;)Z
    ...
    .line 408
    invoke-virtual {p0, p1, p2, v2, v5}, Landroidx/emoji2/text/EmojiProcessor;->hasGlyph(Ljava/lang/CharSequence;IILandroidx/emoji2/text/TypefaceEmojiRasterizer;)Z
