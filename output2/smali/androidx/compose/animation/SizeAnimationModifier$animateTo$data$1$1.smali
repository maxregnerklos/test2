.class public final Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 121
    .local v9, "this":Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v1, v9, Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;->$this_apply:Landroidx/compose/animation/SizeAnimationModifier$AnimData;
    ...
    iget-wide v2, v9, Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;->$targetSize:J

    invoke-static {v2, v3}, Landroidx/compose/ui/unit/IntSize;->box-impl(J)Landroidx/compose/ui/unit/IntSize;

    move-result-object v2

    iget-object v3, v9, Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;->this$0:Landroidx/compose/animation/SizeAnimationModifier;

    invoke-virtual {v3}, Landroidx/compose/animation/SizeAnimationModifier;->getAnimSpec()Landroidx/compose/animation/core/AnimationSpec;
    ...
    iput v6, v9, Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;->label:I
    ...
    .line 123
    iget-object v1, v9, Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;->this$0:Landroidx/compose/animation/SizeAnimationModifier;

    invoke-virtual {v1}, Landroidx/compose/animation/SizeAnimationModifier;->getListener()Lkotlin/jvm/functions/Function2;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-object v2, v9, Landroidx/compose/animation/SizeAnimationModifier$animateTo$data$1$1;->$this_apply:Landroidx/compose/animation/SizeAnimationModifier$AnimData;

    invoke-virtual {v2}, Landroidx/compose/animation/SizeAnimationModifier$AnimData;->getStartSize-YbymL2g()J
