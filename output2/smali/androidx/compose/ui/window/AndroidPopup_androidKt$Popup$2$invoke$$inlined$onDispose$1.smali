...
.method public dispose()V
    ...
    .line 485
    .local v0, "$i$a$-onDispose-AndroidPopup_androidKt$Popup$2$1":I
    iget-object v1, p0, Landroidx/compose/ui/window/AndroidPopup_androidKt$Popup$2$invoke$$inlined$onDispose$1;->$popupLayout$inlined:Landroidx/compose/ui/window/PopupLayout;

    invoke-virtual {v1}, Landroidx/compose/ui/platform/AbstractComposeView;->disposeComposition()V

    .line 487
    iget-object v1, p0, Landroidx/compose/ui/window/AndroidPopup_androidKt$Popup$2$invoke$$inlined$onDispose$1;->$popupLayout$inlined:Landroidx/compose/ui/window/PopupLayout;

    invoke-virtual {v1}, Landroidx/compose/ui/window/PopupLayout;->dismiss()V

    .line 488
    nop

    .line 64
    .end local v0    # "$i$a$-onDispose-AndroidPopup_androidKt$Popup$2$1":I
    nop
