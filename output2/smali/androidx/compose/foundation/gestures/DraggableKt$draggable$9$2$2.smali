.class public final Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;
...
# direct methods
.method public constructor <init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlinx/coroutines/channels/Channel;Landroidx/compose/foundation/gestures/Orientation;Lkotlin/coroutines/Continuation;)V
    .locals 1
...
.method public final invoke(Landroidx/compose/foundation/gestures/DragScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "this":Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;
    .local p1, "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->L$1:Ljava/lang/Object;

    check-cast v2, Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v3, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "this":Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;
    ...
    .restart local v1    # "this":Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->L$0:Ljava/lang/Object;
    ...
    :goto_0
    iget-object v2, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->$event:Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v2, v2, Lkotlin/jvm/internal/Ref$ObjectRef;->element:Ljava/lang/Object;

    instance-of v4, v2, Landroidx/compose/foundation/gestures/DragEvent$DragStopped;

    if-nez v4, :cond_3

    instance-of v4, v2, Landroidx/compose/foundation/gestures/DragEvent$DragCancelled;
    ...
    iget-object v4, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->$orientation:Landroidx/compose/foundation/gestures/Orientation;
    ...
    .line 245
    .local v5, "$i$a$-let-DraggableKt$draggable$9$2$2$1":I
    ...
    .end local v5    # "$i$a$-let-DraggableKt$draggable$9$2$2$1":I
    :cond_1
    iget-object v2, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->$event:Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v4, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->$channel:Lkotlinx/coroutines/channels/Channel;

    iput-object v3, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->L$0:Ljava/lang/Object;

    iput-object v2, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->L$1:Ljava/lang/Object;

    const/4 v5, 0x1

    iput v5, v1, Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;->label:I
    ...
    .local v2, "this":Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;
    ...
    .end local v2    # "this":Landroidx/compose/foundation/gestures/DraggableKt$draggable$9$2$2;
