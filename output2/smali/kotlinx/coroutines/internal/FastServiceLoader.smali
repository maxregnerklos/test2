...
# virtual methods
.method public final getProviderInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;
    .locals 4
...
.method public final load(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    .locals 2
...
.method public final loadMainDispatcherFactory$kotlinx_coroutines_core()Ljava/util/List;
    ...
    invoke-virtual {p0, v0, v1}, Lkotlinx/coroutines/internal/FastServiceLoader;->load(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-virtual {p0, v0, v2}, Lkotlinx/coroutines/internal/FastServiceLoader;->load(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
...
.method public final loadProviders$kotlinx_coroutines_core(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-virtual {v11, v9}, Lkotlinx/coroutines/internal/FastServiceLoader;->parse(Ljava/net/URL;)Ljava/util/List;
    ...
    invoke-static {v4, v9}, Lkotlin/collections/CollectionsKt__MutableCollectionsKt;->addAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z
    ...
    invoke-virtual {v12, v10, p2, p1}, Lkotlinx/coroutines/internal/FastServiceLoader;->getProviderInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public final parse(Ljava/net/URL;)Ljava/util/List;
    .locals 14
    ...
    invoke-static {v0, v1, v4, v3, v4}, Lkotlin/text/StringsKt__StringsKt;->substringAfter$default(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    const/16 v5, 0x21

    invoke-static {v1, v5, v4, v3, v4}, Lkotlin/text/StringsKt__StringsKt;->substringBefore$default(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v0, v5, v4, v3, v4}, Lkotlin/text/StringsKt__StringsKt;->substringAfter$default(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v13, v11}, Lkotlinx/coroutines/internal/FastServiceLoader;->parseFile(Ljava/io/BufferedReader;)Ljava/util/List;
    ...
    .end local v8    # "file":Ljava/util/jar/JarFile;
    .end local v9    # "$i$a$-use-FastServiceLoader$parse$1":I
    .end local p0    # "this":Lkotlinx/coroutines/internal/FastServiceLoader;
    ...
    .restart local v8    # "file":Ljava/util/jar/JarFile;
    .restart local v9    # "$i$a$-use-FastServiceLoader$parse$1":I
    .restart local p0    # "this":Lkotlinx/coroutines/internal/FastServiceLoader;
    ...
    .line 142
    invoke-static {v7, v4}, Lkotlin/ExceptionsKt__ExceptionsKt;->addSuppressed(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v2}, Lkotlinx/coroutines/internal/FastServiceLoader;->parseFile(Ljava/io/BufferedReader;)Ljava/util/List;
...
.method public final parseFile(Ljava/io/BufferedReader;)Ljava/util/List;
    .locals 12
