...
.method public calculateTargetStateOnViewReleased(Landroid/view/View;FF)I
    ...
    .line 81
    invoke-virtual {p0, p2, p3}, Lcom/google/android/material/sidesheet/RightSheetDelegate;->isSwipeSignificant(FF)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {p0, p1}, Lcom/google/android/material/sidesheet/RightSheetDelegate;->isReleasedCloseToOriginEdge(Landroid/view/View;)Z
...
.method public final isReleasedCloseToOriginEdge(Landroid/view/View;)Z
    .locals 3
    .param p1, "releasedChild"    # Landroid/view/View;
