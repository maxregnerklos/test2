.class public Lcom/topjohnwu/superuser/internal/PendingJob;
.super Lcom/topjohnwu/superuser/internal/JobImpl;
.source "PendingJob.java"


# instance fields
.field public final isSU:Z

.field public retry:Z


# direct methods
.method public static synthetic $r8$lambda$P4Y3tmoGldHqGKxe_D6jBkeWU94(Lcom/topjohnwu/superuser/internal/PendingJob;Ljava/util/concurrent/Executor;Lcom/topjohnwu/superuser/Shell$ResultCallback;Lcom/topjohnwu/superuser/Shell$Result;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2, p3}, Lcom/topjohnwu/superuser/internal/PendingJob;->lambda$submit$0(Ljava/util/concurrent/Executor;Lcom/topjohnwu/superuser/Shell$ResultCallback;Lcom/topjohnwu/superuser/Shell$Result;)V

    return-void
.end method

.method public static synthetic $r8$lambda$bS70F1tiBbXB-YYIpfktjueOJJc(Lcom/topjohnwu/superuser/internal/PendingJob;Ljava/util/concurrent/Executor;Lcom/topjohnwu/superuser/Shell$ResultCallback;Lcom/topjohnwu/superuser/Shell;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2, p3}, Lcom/topjohnwu/superuser/internal/PendingJob;->lambda$submit$1(Ljava/util/concurrent/Executor;Lcom/topjohnwu/superuser/Shell$ResultCallback;Lcom/topjohnwu/superuser/Shell;)V
...
.method public constructor <init>(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/topjohnwu/superuser/internal/JobImpl;->to(Ljava/util/List;)Lcom/topjohnwu/superuser/Shell$Job;

    .line 37
    return-void
.end method

.method private synthetic lambda$submit$0(Ljava/util/concurrent/Executor;Lcom/topjohnwu/superuser/Shell$ResultCallback;Lcom/topjohnwu/superuser/Shell$Result;)V
    .locals 1
...
.method private synthetic lambda$submit$1(Ljava/util/concurrent/Executor;Lcom/topjohnwu/superuser/Shell$ResultCallback;Lcom/topjohnwu/superuser/Shell;)V
    .locals 1
    .param p1, "executor"    # Ljava/util/concurrent/Executor;
    .param p2, "cb"    # Lcom/topjohnwu/superuser/Shell$ResultCallback;
    ...
    .line 71
    :cond_0
    iget-object v0, p0, Lcom/topjohnwu/superuser/internal/JobImpl;->out:Ljava/util/List;
    ...
    :goto_0
    iput-object v0, p0, Lcom/topjohnwu/superuser/internal/JobImpl;->out:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/topjohnwu/superuser/internal/JobImpl;->shell:Lcom/topjohnwu/superuser/internal/ShellImpl;
...
.method public exec()Lcom/topjohnwu/superuser/Shell$Result;
    ...
    .line 48
    iget-boolean v1, p0, Lcom/topjohnwu/superuser/internal/PendingJob;->isSU:Z
