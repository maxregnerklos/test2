...
.method public bridge synthetic update(Landroidx/compose/ui/Modifier$Node;)Landroidx/compose/ui/Modifier$Node;
    ...
    invoke-virtual {p0, v0}, Landroidx/compose/ui/draw/DrawBehindElement;->update(Landroidx/compose/ui/draw/DrawBackgroundModifier;)Landroidx/compose/ui/draw/DrawBackgroundModifier;
...
.method public update(Landroidx/compose/ui/draw/DrawBackgroundModifier;)Landroidx/compose/ui/draw/DrawBackgroundModifier;
    ...
    .local v0, "$this$update_u24lambda_u240":Landroidx/compose/ui/draw/DrawBackgroundModifier;
    const/4 v1, 0x0

    .line 99
    .local v1, "$i$a$-apply-DrawBehindElement$update$1":I
    iget-object v2, p0, Landroidx/compose/ui/draw/DrawBehindElement;->onDraw:Lkotlin/jvm/functions/Function1;

    invoke-virtual {v0, v2}, Landroidx/compose/ui/draw/DrawBackgroundModifier;->setOnDraw(Lkotlin/jvm/functions/Function1;)V

    .line 100
    nop

    .line 98
    .end local v0    # "$this$update_u24lambda_u240":Landroidx/compose/ui/draw/DrawBackgroundModifier;
    .end local v1    # "$i$a$-apply-DrawBehindElement$update$1":I
    nop
