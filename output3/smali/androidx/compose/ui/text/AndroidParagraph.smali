...
.method public constructor <init>(Landroidx/compose/ui/text/platform/AndroidParagraphIntrinsics;IZJ)V
    ...
    iput-object v12, v13, Landroidx/compose/ui/text/AndroidParagraph;->paragraphIntrinsics:Landroidx/compose/ui/text/platform/AndroidParagraphIntrinsics;

    .line 94
    iput v14, v13, Landroidx/compose/ui/text/AndroidParagraph;->maxLines:I

    .line 95
    iput-boolean v15, v13, Landroidx/compose/ui/text/AndroidParagraph;->ellipsis:Z
    ...
    invoke-static {v7, v15}, Landroidx/compose/ui/text/AndroidParagraph_androidKt;->access$shouldAttachIndentationFixSpan(Landroidx/compose/ui/text/TextStyle;Z)Z
    ...
    .line 188
    invoke-static {v1, v13}, Lkotlin/ranges/RangesKt___RangesKt;->coerceAtLeast(II)I
    ...
    invoke-virtual/range {v4 .. v12}, Landroidx/compose/ui/text/AndroidParagraph;->constructTextLayout(IILandroid/text/TextUtils$TruncateAt;IIIII)Landroidx/compose/ui/text/android/TextLayout;
    ...
    iput-object v4, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;
    ...
    .line 198
    iput-object v0, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;
    ...
    invoke-virtual {v1, v4, v7, v8, v9}, Landroidx/compose/ui/text/platform/AndroidTextPaint;->setBrush-12SF9DM(Landroidx/compose/ui/graphics/Brush;JF)V

    .line 204
    iget-object v1, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;

    invoke-virtual {v5, v1}, Landroidx/compose/ui/text/AndroidParagraph;->getShaderBrushSpans(Landroidx/compose/ui/text/android/TextLayout;)[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    ...
    .local v10, "shaderBrushSpan":Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    const/4 v11, 0x0

    .line 205
    .local v11, "$i$a$-forEach-AndroidParagraph$3":I
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/text/AndroidParagraph;->getWidth()F
    ...
    invoke-static {v12, v6}, Landroidx/compose/ui/geometry/SizeKt;->Size(FF)J

    move-result-wide v13

    invoke-virtual {v10, v13, v14}, Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;->setSize-uvyYCjk(J)V

    .line 206
    nop

    .line 13579
    .end local v10    # "shaderBrushSpan":Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    .end local v11    # "$i$a$-forEach-AndroidParagraph$3":I
    nop
    ...
    .line 242
    iget-object v0, v5, Landroidx/compose/ui/text/AndroidParagraph;->charSequence:Ljava/lang/CharSequence;
    ...
    .line 245
    .local v13, "$i$a$-map-AndroidParagraph$placeholderRects$1$1":I
    move-object v14, v0
    ...
    .local v16, "$this$placeholderRects_u24lambda_u246":Ljava/lang/CharSequence;
    iget-object v0, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;

    invoke-virtual {v0, v14}, Landroidx/compose/ui/text/android/TextLayout;->getLineForOffset(I)I
    ...
    iget v1, v5, Landroidx/compose/ui/text/AndroidParagraph;->maxLines:I
    ...
    iget-object v2, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;
    ...
    .local v20, "$i$f$map":I
    iget-object v3, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;
    ...
    .line 259
    :cond_10
    invoke-virtual {v5, v14}, Landroidx/compose/ui/text/AndroidParagraph;->getBidiRunDirection(I)Landroidx/compose/ui/text/style/ResolvedTextDirection;

    move-result-object v21

    .line 261
    .local v21, "direction":Landroidx/compose/ui/text/style/ResolvedTextDirection;
    sget-object v22, Landroidx/compose/ui/text/AndroidParagraph$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .end local v22    # "exceedsMaxLines":Z
    ...
    .end local v1    # "exceedsMaxLines":Z
    .restart local v22    # "exceedsMaxLines":Z
    invoke-virtual {v5, v14, v1}, Landroidx/compose/ui/text/AndroidParagraph;->getHorizontalPosition(IZ)F
    ...
    .local v24, "isPlaceholderSpanTruncated":Z
    iget-object v3, v5, Landroidx/compose/ui/text/AndroidParagraph;->layout:Landroidx/compose/ui/text/android/TextLayout;
    ...
    .line 270
    .local v26, "$i$a$-with-AndroidParagraph$placeholderRects$1$1$top$1":I
    ...
    .local v30, "$this$mapTo$iv$iv":[Ljava/lang/Object;
    new-instance v6, Ljava/lang/IllegalStateException;

    const-string v7, "unexpected verticalAlignment"
    ...
    .line 282
    .end local v30    # "$this$mapTo$iv$iv":[Ljava/lang/Object;
    .restart local v7    # "$this$mapTo$iv$iv":[Ljava/lang/Object;
    :pswitch_2
    ...
    .local v6, "$this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244_u24lambda_u243":Landroid/graphics/Paint$FontMetricsInt;
    const/16 v29, 0x0

    .line 283
    .local v29, "$i$a$-with-AndroidParagraph$placeholderRects$1$1$top$1$1":I
    move-object/from16 v30, v7

    .end local v7    # "$this$mapTo$iv$iv":[Ljava/lang/Object;
    .restart local v30    # "$this$mapTo$iv$iv":[Ljava/lang/Object;
    iget v7, v6, Landroid/graphics/Paint$FontMetricsInt;->ascent:I
    ...
    .line 282
    .end local v6    # "$this$placeholderRects_u24lambda_u246_u24lambda_u245_u24lambda_u244_u24lambda_u243":Landroid/graphics/Paint$FontMetricsInt;
    .end local v29    # "$i$a$-with-AndroidParagraph$placeholderRects$1$1$top$1$1":I
    goto/16 :goto_11
    ...
    .end local v26    # "$i$a$-with-AndroidParagraph$placeholderRects$1$1$top$1":I
    move v3, v7
    ...
    invoke-direct {v7, v2, v3, v1, v6}, Landroidx/compose/ui/geometry/Rect;-><init>(FFFF)V

    goto :goto_13

    .line 255
    .end local v21    # "direction":Landroidx/compose/ui/text/style/ResolvedTextDirection;
    .end local v22    # "exceedsMaxLines":Z
    .end local v24    # "isPlaceholderSpanTruncated":Z
    ...
    .end local v8    # "$i$f$mapTo":I
    .restart local v22    # "exceedsMaxLines":Z
    .restart local v24    # "isPlaceholderSpanTruncated":Z
    .restart local v25    # "isPlaceholderSpanEllipsized":Z
    ...
    .end local v13    # "$i$a$-map-AndroidParagraph$placeholderRects$1$1":I
    ...
    .line 11672
    .end local v16    # "$this$placeholderRects_u24lambda_u246":Ljava/lang/CharSequence;
    ...
    .end local v7    # "$this$mapTo$iv$iv":[Ljava/lang/Object;
    .end local v8    # "$i$f$mapTo":I
    .restart local v16    # "$this$placeholderRects_u24lambda_u246":Ljava/lang/CharSequence;
    ...
    .end local v17    # "$i$a$-with-AndroidParagraph$placeholderRects$1":I
    :goto_14
    iput-object v2, v5, Landroidx/compose/ui/text/AndroidParagraph;->placeholderRects:Ljava/util/List;
    ...
    invoke-direct {v1, v5}, Landroidx/compose/ui/text/AndroidParagraph$wordBoundary$2;-><init>(Landroidx/compose/ui/text/AndroidParagraph;)V

    invoke-static {v0, v1}, Lkotlin/LazyKt__LazyJVMKt;->lazy(Lkotlin/LazyThreadSafetyMode;Lkotlin/jvm/functions/Function0;)Lkotlin/Lazy;

    move-result-object v0

    iput-object v0, v5, Landroidx/compose/ui/text/AndroidParagraph;->wordBoundary$delegate:Lkotlin/Lazy;
...
.method public final getShaderBrushSpans(Landroidx/compose/ui/text/android/TextLayout;)[Landroidx/compose/ui/text/platform/style/ShaderBrushSpan;
    .locals 4
...
.method public final getWordBoundary()Landroidx/compose/ui/text/android/selection/WordBoundary;
    .locals 1
...
.method public getWordBoundary--jx7JFs(I)J
    ...
    .line 384
    invoke-virtual {p0}, Landroidx/compose/ui/text/AndroidParagraph;->getWordBoundary()Landroidx/compose/ui/text/android/selection/WordBoundary;
